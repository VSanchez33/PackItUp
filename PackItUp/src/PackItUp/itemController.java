...
public class itemController implements Controller<Item>{
    ...
    public void initialize() {
        if (currentItem != null) {
            ...
            statusField.setText(currentItem.getStatus());
            amountField.setText(currentItem.getQuantity());
    ...
    public void save(ActionEvent event) throws IOException {
        if (currentItem != null) {
            ...
            currentItem.setStatus(statusField.getText());
            currentItem.setQuantity(amountField.getText());
        } // end of if
        else{
            Item newItem = new Item();
            newItem.setName(nameField.getText());
            newItem.setDate(datePicker.getValue().toString());
            newItem.setStatus(statusField.getText());
            newItem.setQuantity(amountField.getText());
